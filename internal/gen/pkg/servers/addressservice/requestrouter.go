...
// Router interface for addressservice
type Router interface {
	Route(router *chi.Mux)
}

// ServiceRouter for addressservice API
...
// NewServiceRouter creates a new service router for addressservice
...
func (s *ServiceRouter) WireRoutes(ctx context.Context, r chi.Router) {
	r.Route(core.SelectBasePath(s.basePathFromSpec, s.gc.BasePath()), func(r chi.Router) {
		...
		r.Get("/address-check", s.svcHandler.GetAddressCheckListHandler)
	})
}
